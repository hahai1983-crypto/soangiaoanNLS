...
<div class="main-header">
    ...
    <p>Tác giả: HÀ THỊ HẢI - Trường TH Hùng An - ĐT: 09978 272 118</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - HÀ THỊ HẢI - Trường TH Hùng An - ĐT: 0978272118</div>", unsafe_allow_html=True)
